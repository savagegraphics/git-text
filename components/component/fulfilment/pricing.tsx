 ...
 * @see https://v0.dev/t/sm7LS5yaJeP
 */
      ...
      <div className='flex flex-col'>
        ...
        <main className='flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6'>
          <div className='flex items-center'>
            <h1 className='font-semibold text-lg md:text-2xl'>Pricing</h1>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className='hidden md:table-cell'>Taxes</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                <TableRow>
                  ...
                  <TableCell>Includes taxes</TableCell>
                </TableRow>
                <TableRow>
                  ...
                  <TableCell>Excludes taxes</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </div>
